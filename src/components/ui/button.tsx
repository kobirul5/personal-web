...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-base font-semibold ring-offset-white transition-colors",
  {
    variants: {
      variant: {
        default:
          "bg-primaryColor text-white hover:bg-transparent hover:border-primaryColor hover:border hover:text-primaryColor ",
        primary: "bg-primaryColor text-white",
        outline: "border border-primaryColor text-primaryColor hover:text-white hover:bg-primaryColor/90",
      },
      size: {
        default: "h-[48px] px-6",
        md: "h-[48px] px-6",
