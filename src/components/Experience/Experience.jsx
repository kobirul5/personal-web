...
const experiences = [
  {
    ...
    type: "Full-time",
    description: "Developing and maintaining scalable backend systems with real-time features and secure payment integrations.",
    responsibilities: [
    ...
    technologies: ["Node.js", "Express.js", "TypeScript", "MongoDB", "Prisma", "WebSocket", "Stripe", "JWT"],
  },
]
...
const Experience = () => {
  ...
  return (
    <section className="relative pb-10 overflow-hidden" id="experience" ref={ref}>
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row gap-8">
                      ...
                      <div className="flex-1">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                          <div>
                            <h3 className="text-2xl md:text-3xl font-bold text-foreground">{exp.title}</h3>
                            <p className="text-lg md:text-xl text-primaryColor font-medium mt-1">{exp.company}</p>
                          </div>
                        ...
                        <div className="flex items-center mt-3 text-muted-foreground">
                          ...
                          <span className="text-primaryColor/80 text-sm font-medium">{exp.type}</span>
                        </div>
