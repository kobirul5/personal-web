...
export const metadata = {
  ...
  openGraph: {
    title: "Md. Kobirul Islam | Full Stack Developer",
    description:
      "Full Stack Developer specializing in Node.js, Express.js, TypeScript, React.js & Next.js. Currently Backend Developer at SM Technology, Bangladesh.",
  ...
  twitter: {
    ...
    title: "Md. Kobirul Islam | Full Stack Developer",
    description:
      "Full Stack Developer specializing in Node.js, Express.js, TypeScript, React.js & Next.js.",
    creator: "@kobirul5",
  },
  robots: {
    index: true,
