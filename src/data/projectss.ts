...
export const projects: Project[] = [
  {
    ...
    description:
      "Friendzo is a full-stack social platform with a Next.js 16 client and an Express + TypeScript backend. It covers the public site, authenticated social experience, events, live messaging, profile pages, discovery flows, store and payment screens, and admin dashboards.",
    technologies: [
      "Next.js 16",
      "React 19",
      "TypeScript",
  ...
  },
  {
    ...
    description:
      "SwiftLearn is a modern and responsive Learning Management System (LMS) frontend built with Next.js (TypeScript) and Tailwind CSS. It provides a seamless experience for both Admins and Users with dynamic course management, module-wise lecture navigation, embedded video player, and secure role-based access.",
    technologies: [
      "Next.js (TypeScript)",
      "Tailwind CSS",
      "Redux Toolkit",
  ...
  },
  {
    ...
    description:
      "A web application for monitoring employee workload, salaries, and HR management. Employees can post workflow updates, HR executives can verify and pay employees, and admins can manage user roles and payroll.",
    technologies: [
      "React",
      "Node.js",
      "MongoDB",
  ...
  },
  {
    ...
    description:
      "A full-stack restaurant management website that allows users to browse food items, place orders, and manage restaurant operations efficiently. The system includes user authentication, food management, order tracking, and a secure payment system.",
    technologies: [
      "React",
      "Node.js",
      "MongoDB",
